...
- **Nexus – A Solid Foundation:** Build a robust digital infrastructure and establish intelligent DevOps processes. Nexus will switch to using lightweight VSCode, optimizing the development experience and ready to integrate AI solutions, bringing AI experience to the Insurance Core. This foundational step ensures stability, security, and long-term scalability for the entire system.
